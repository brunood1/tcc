...
\begin{frame}
    \frametitle{Exemplos}
    \begin{center}
        \animategraphics[autoplay,loop,width=0.85\linewidth]{200}{frames/frame-}{0001}{0660}\\
    \end{center}
\end{frame}
\begin{frame}
    \frametitle{Exemplos}
...
\end{frame}
\begin{frame}
    \frametitle{Desigualdades gerais de Sobolev}
    \only<1>{
    \begin{block}{Teorema}
...
\begin{frame}
    ...
    \item $\cW^{1,p}_0(\Omega) \hookrightarrow \cL^{p}(\Omega)$, com $1 \leqslant p \leqslant \infty$;
