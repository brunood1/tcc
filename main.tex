...
\begin{ex}
    ...
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}
            \filldraw[ForestGreen!30] (2,2) rectangle (0,0);
            \filldraw[ForestGreen!30] (-2,-2) rectangle (0,0);
            \filldraw[ForestGreen!40] (-2,2) rectangle (0,0);
            \filldraw[ForestGreen!40] (2,-2) rectangle (0,0);
...
\begin{prf}
    ...
    \]
    Dessa forma, como $\Gamma \subseteq \partial B^+$ e $\xi(x) = 1$ para todo $x \in \hat B$, concluimos que
    \[
