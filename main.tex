...
\begin{prf}
    ...
    \[
        D^\alpha u = u_\alpha.
    \]
    Com efeito, pelo \nameref{thm:teorema-da-convergencia-dominada} \textcolor{red}{(e o teorema no livro do Brezis, ver pág e número)} e utlizando a definição de derivada fraca, obtemos
    \[
        \begin{aligned}
