...
Note que $\{x \in \Omega \,; \varphi(x) \neq 0\} \subseteq \supp \varphi$; então, $(\supp \varphi)^\cC \subseteq\footnotemark \{x \in \Omega \,; \varphi(x) = 0\}$. Ou seja, se $x \not\in \supp \varphi$, então $\varphi(x) = 0$.
    ...
    \begin{figure} 
        ...
        \begin{tikzpicture}
            \begin{scope}[shift={(-4,0)}, scale=0.8]
                ...
                \draw[thick, black!60, -stealth] (-4,0) to (4,0); 
                \draw[thick, black!60, -stealth] (0,-4) to (0,4); 
                \draw[domain=-0.9999:0.9999, variable=\x, samples=50, smooth, very thick, ForestGreen!90!black] plot ({\x}, {2.257 * exp(-1 / (1 - (\x * \x)))});
                \draw[very thick, ForestGreen!90!black] (-1,0) -- (-3,0);
                \draw[very thick, ForestGreen!90!black] (1,0) -- (3,0);
            \end{scope}
            ...
            \begin{scope}[shift={(4,0)}, scale=0.8]
                ...
                \draw[thick, black!60, -stealth] (-4,0) to (4,0); 
                \draw[thick, black!60, -stealth] (0,-4) to (0,4); 
                \draw[domain=-0.299:0.299, variable=\x, samples=50, smooth, very thick, ForestGreen!90!black] plot ({\x}, {(1/0.3) * 2.257 * exp(-1 / (1 - ((\x / 0.3) * (\x / 0.3))))});
                \draw[very thick, ForestGreen!90!black] (-0.3,0) -- (-3,0);
                \draw[very thick, ForestGreen!90!black] (0.3,0) -- (3,0);
            \end{scope}
        \end{tikzpicture}
...
\begin{figure}
    ...
    \begin{tikzpicture}[scale=1.5]
        \draw[thick, dashed, ForestGreen!30!black, fill=ForestGreen!30] (-2.076,1.929) .. controls (-1.374,-0.882) and (-0.462,2.304) .. (0.81,1.5) .. controls (2.112,0.549) and (2.121,1.836) .. (2.136,1.941) to (2.136,1.929);
        ...
        \draw[stealth-stealth, thick, OliveGreen!50!black, font=\small] (0.5616,0) to node[right] {$\gamma(x_1,\dots,x_{n-1})$} (0.5616,1.6102);
        \node[below=2pt,font=\footnotesize, fill=white] at (0.5616,0) {$(x_1,\dots,x_{n-1})$};
        \filldraw (0.5616,0) circle (0.03);

        \node[OliveGreen] at (-1.419,1.524) {$\Omega$};
        \node[ForestGreen!30!black] at (-0.5,0.8) {$\partial\Omega$};
    \end{tikzpicture}
...
\begin{prf}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[scale=1.75]
            ...
            \draw[thick, dashed, fill=YellowGreen, fill opacity=0.2, draw=black!70] (1.5,0) circle (1.25);
            \draw[thick, dashed, fill=YellowGreen, fill opacity=0.3, draw=black!70] (1.5,0) circle (0.625);
        
            \draw[Blue, thick] (0.25,0) to (2.75,0);
            \node[above=-1pt, Blue] at (2.4,0) {$\partial \Omega$};
        
            \draw[LimeGreen!80!black, thick, dash pattern=on 4.5pt off 2pt] (0.875,0) to (2.125,0);
            \node[above=-1pt, LimeGreen!80!black] at (1.1875,0) {$\Gamma_{\tilde x}$};
...
\begin{prf}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \begin{scope}
                \clip \CA;
                \fill[ForestGreen!25] \CB;
            \end{scope}     
            \begin{scope}
                \clip \CA;
                \draw[ForestGreen, dashed, very thick] \CB;
            \end{scope}
            \begin{scope}
                \clip \CB;
                \draw[ForestGreen, dashed, very thick] \CA;
            \end{scope}    
