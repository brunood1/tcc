...
\begin{prf}
    ...
    Se $t' \geqslant t_2$, então por () temos
    \[
        \begin{aligned}
    ...
    \]
    Por outro lado, se $t'< t_2$, podemos reescrever (\small{4.13}) como
    \[
    ...
    \[
        ...
        \end{aligned}
    \]
    Lembrando que $U_k(s)^{\frac{3}{4}} \leqslant 1 + U_k(s)$, segue por () que
    \[
