...
\footnotetext{
    ...
    \begin{itemize}[label=$\cdot$]
        \item $\cL^\infty\big([0,\infty), \cL^2_\sigma(\bR^3)\big)$ é o espaço das funções $\bu(\cdot,t) : [0,\infty) \to \cL^2(\bR^3)$ tal que $\nabla \cdot \bu =0$ e $\Vert \bu(\cdot,t) \Vert_{\cL^2(\bR^3)} < \infty$.
        \item $\cC_w\left([0,\infty), \cL^2(\bR^3)\right)$ é o espaço das funções $\bu(\cdot,t) : [0,\infty) \to \cL^2(\bR^3)$ fracamente contínuas.
        \item $\cL^2\big([0,\infty), \dot H^1(\bR^3)\big)$ é o espaço das funções $\bu(\cdot,t) : [0,\infty) \to \dot H^1(\bR^3)$ tal que
        \[
