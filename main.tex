...
\begin{prf}
    ...
    \[
        \begin{aligned}
            ...
            B^- &= B \cap \{x_n = 0\} \subseteq \bR^n \smallsetminus \Omega.
        \end{aligned}
    \]
    ...
    \[
        c\sum_{|\alpha| \leqslant 1} \sum_{i=0}^{N} \sum_{\sigma \leqslant \alpha} \binom{\alpha}{\sigma} \Vert \bar u_i \Vert_{\cW^{1,p}(W_i)}^p \leqslant c\Vert \bar u_i \Vert_{\cW^{1,p}(\Omega)}
    \]
    ...
    Defina $\Omega'$ de forma que $\bigcup_{i=0}^N W_i \subseteq \Omega'$ \dots
    
    Defina $\tilde E: \cC^\infty(\overline\Omega) \to C^\infty(\bR^n)$ dada por $\bar E u = \bar u$.
    Temos que $\bar E$ é linear e
    \[
